...
TEST(PageGuardTest, MoveTest) {
  ...
  BasicPageGuard move1 = std::move(guarded_page);

  EXPECT_EQ(page0->GetData(), move1.GetData());
  EXPECT_EQ(page0->GetPageId(), move1.PageId());
  EXPECT_EQ(1, page0->GetPinCount());

  BasicPageGuard move2{std::move(move1)};

  EXPECT_EQ(page0->GetData(), move2.GetData());
  EXPECT_EQ(page0->GetPageId(), move2.PageId());
  EXPECT_EQ(1, page0->GetPinCount());
